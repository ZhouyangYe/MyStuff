	...
	<div class="main fl">
		...
		<div class="main_wrap clear">
			...
			<div class="section fl">
				<h2 class="video_title">WHAT'S HOT</h2>
				<div class="video">
					<video id="content" width="640" height="360">
						<source src="video/video.mp4">
					</video>
					<nav class="nav">
						<div id="buttons">
							<button type="button" id="play">Go</button>
							<button type="button" id="volume"><img src="img/volume.png"></img></button>
						</div>
						<div id="defaultBar">
				...
				<ul class="video_list">
					...
					<li><a href="#">现场实录：杭州机场机场系统崩溃</a></li>
					<li><a href="#">现场实录：杭州机场机场机场系统崩溃</a></li>
				</ul>
			</div>
				...
				<div class="con">
					<div class="info clear">
						...
						<div class="text">
							...
							<p>迟到的荣誉——电商网站电商网站电商网站电商网站电商网站</p>
						</div>
					</div>
					<div class="calendar">
						<h3>
						...
						<ol>
							...
							<li>23</li>
							<li>24</li>
							<li>25<img class="img" info="迟到的荣誉——电商网站电商网站电商网站" src="img/content/today2.gif" alt="" /></li>
							<li>26</li>
							<li>27<img class="img" info="好味道好味道好味道好味道好味道好味道" src="img/content/hot_list_pic2.gif" alt="" /></li>
							<li>28</li>
							<li>29<img class="img" info="气质美女气质美女气质美女气质美女" src="img/content/hot10.gif" alt="" /></li>
							<li>30<img class="img" info="帅哥帅哥帅哥帅哥帅哥帅哥帅哥帅哥" src="img/content/hot11.gif" alt="" /></li>
							<li>31</li>
		...
		<div class="main_wrap clear">
			...
			<div class="section fl">
				...
				<div class="help">
					...
					<ul>
						<li class="phone fl">506-292-8077</li>
						<li class="msn fr">zye0821@gmail.com</li>
					</ul>
					<dl class="fl">
						<dt>用户帮助</dt>
...
<div id="footer">
	...
	<a href="#">网站地图</a> |
	<a href="#">视频索引</a><br />
	Copyright &copy; 2016 zhouyangbt.ca 100度享乐网 版权所有 <span>京ICP证0843234号</span>
</div>
